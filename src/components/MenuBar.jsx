    ...
    <Flex width="70%" margin="auto">
      ...
      <Box className="dropdown">
        <RouteLink to={"/product/makeup"}>
          {" "}
          <Box fontFamily="Roboto" className="dropbtn">
            MAKEUP
          </Box>
        </RouteLink>
          ...
          <Box width="1200px">
            <Flex>
              ...
              >
                <Box>
                  <CollectionCards
                    name={"Manish Malhotra 9 in 1 Eyeshado"}
                    image={
                ...
                <Box>
                  <CollectionCards
                    ...
                    image={
                      "https://files.myglamm.com/site-images/400x400/GGM-(1).jpg"
                    }
                  />
                </Box>
                <Box>
                  <CollectionCards
                    name={"MyGlamm LIT Creamy Matte Lipst.."}
                    image={
      ...
      <Box className="dropdown">
        ...
        <Box className="dropdown-content" marginLeft="-1090px"></Box>
      </Box>
    </Flex>
  );
};
